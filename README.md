...
> 专为硬件工程师和算法开发者打造的轻量级触觉马达（LRA / VCM）二阶物理求解器与动态位移仿真引擎。
 ...
 English | [简体中文](README_CN.md) | 🌐 **[🚀 Online Live Studio Demo](https://tonychen5577-tech.github.io/ansv-haptics-sim/)**

---

## 📈 Interactive Simulation Preview

- 🌐 **Interactive Web Studio**: Open [`docs/index.html`](docs/index.html) or visit [Online Live Studio Demo](https://tonychen5577-tech.github.io/ansv-haptics-sim/) to tweak parameters in real-time with synchronized 2D haptic motor physics animation!
...
## 🎛️ Motor Control & Haptic Drive Strategies [Planned]
...
1. 🔄 **[Planned] Overdrive Control (Fast Transient Rise)**:
...
2. 🔄 **[Planned] Active Braking (Active Deceleration)**:
...
3. 🔄 **[Planned] Closed-Loop Resonance Tracking (Auto-Resonance)**:
