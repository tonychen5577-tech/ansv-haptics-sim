...
> 我们在工业仿真与数据采集领域的主力工程工具一直为 **LabVIEW**。目前团队正在积极学习与研究 **JavaScript** 在 Web 端物理可视化中的应用。随着代码与求解引擎的不断迭代，我们将持续调整与更新本开源项目的相关内容。非常欢迎开源社区开发者提出建议与提交 PR 共同交流！  
> 
> 🌐 欢迎访问我们的开放实验室主页交流：[ansv.net/simulations/](https://ansv.net/simulations/)
